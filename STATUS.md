...
1. **BLOCK-1 MILESTONE SIGN-OFF (trader):** all exit criteria appear satisfied (full signal path TradingView-shape webhook -> n8n -> outbox -> VM share -> NT8 consumer -> Sim101 bracket, running on sim data; T1-T4 evidence audited). Trader records sign-off in STATUS.md + Google Sheets. Pending trader decisions carried with the ask: (a) OnTermination-journaling DECLINE ratification (runbook §6.2), (b) whether btb (P2) must land pre- or post-milestone, (c) flatten-or-let-work the open Sim101 bracket.
...
- [ ] Block 1 — Foundation (current — Build-First; education runs parallel, gate moved to pre-live per D-2026-07-04-A)
  ...
  - [ ] **Block 1 MILESTONE — trader sign-off PENDING** (all exit criteria appear satisfied; ask assembled 2026-07-15; known-open bugs at ask time: btb P2, 518 P2-near-monitor, 01h P3, qxd P3)
- [ ] Block 2 — Backtesting

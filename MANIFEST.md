...
| /scripts/praxis-signals-stale-check.sh | Script | 1 | 2026-07-09 | B1-c (bead dnt) stale-heartbeat check — if .heartbeat >180s fires Telegram via notify.sh (webhook from ~/.praxis/signals.env), latch prevents spam; SOURCE ONLY |
